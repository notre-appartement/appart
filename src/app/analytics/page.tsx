        ...
        <div className="container mx-auto px-4 py-8">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 border border-blue-200">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-semibold text-gray-800">Appartements vus</h3>
                  <FaChartLine className="text-3xl text-blue-600" />
                </div>
                <p className="text-4xl font-bold text-blue-600 mb-2">12</p>
                <p className="text-sm text-gray-600">+3 ce mois-ci</p>
              </div>

              <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6 border border-green-200">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-semibold text-gray-800">Prix moyen observé</h3>
                  <FaChartPie className="text-3xl text-green-600" />
                </div>
                <p className="text-4xl font-bold text-green-600 mb-2">1 245€</p>
                <p className="text-sm text-gray-600">Pour 52m² en moyenne</p>
              </div>

              <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-6 border border-purple-200">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-semibold text-gray-800">Meilleur rapport</h3>
                  <FaTrophy className="text-3xl text-purple-600" />
                </div>
                <p className="text-4xl font-bold text-purple-600 mb-2">23€/m²</p>
                <p className="text-sm text-gray-600">Appartement rue de la Paix</p>
              </div>
            </div>
              ...
              <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
                ...
                <div className="h-64 bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg flex items-center justify-center border border-blue-200">
                  <div className="text-center">
                    ...
                    <p className="text-gray-600">Graphique d'évolution temporelle</p>
              ...
              <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
                ...
                <div className="h-64 bg-gradient-to-br from-green-50 to-green-100 rounded-lg flex items-center justify-center border border-green-200">
                  <div className="text-center">
                    ...
                    <p className="text-gray-600">Graphique en camembert</p>
                    <p className="text-sm text-gray-500 mt-2">
                      (Intégration Chart.js à venir)
                    </p>
                  </div>
            ...
            <div className="mt-8 bg-gradient-to-r from-yellow-50 to-orange-50 rounded-xl p-6 border-2 border-orange-200">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-gray-800">Votre budget est cohérent</p>
                ...
                <li className="flex items-start gap-3">
                  <span className="text-2xl">📍</span>
                  <div>
                    <p className="font-semibold text-gray-800">Quartier préféré détecté</p>
                    <p className="text-sm text-gray-600">
                ...
                <li className="flex items-start gap-3">
                  <span className="text-2xl">⏰</span>
                  <div>
                    <p className="font-semibold text-gray-800">Rythme de recherche optimal</p>
                    <p className="text-sm text-gray-600">
            ...
            <div className="mt-8 text-center">
              <p className="text-sm text-gray-500 bg-blue-50 border border-blue-200 rounded-lg p-4 inline-block">
